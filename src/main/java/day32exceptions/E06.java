...
public class E06 {
    ...
    2) Database ile baglantiyi kesme isini yapan kodlar gibi kodlar her halukarda calistirilmalidir, bu tarz
        kodlari finally block icine koyariz
    3) try tek basina kullanilamaz, try + catch olabilir, try + cok catch olabilir
        try catch block olmadan sadece finally block ileride kullanilabilir
